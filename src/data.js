export default {
    info: {
        ...
        skills : ["HTML,CSS, SCSS", "JavaScript ES6+", "Vue.js, Vuetify", "Rest API", "Git", "PHP, Laravel", "Python: Flask, aio-http"],
        location: "Иркутск",
        ...
        },
        {
            ...
            [
                ...
                },
                {
                    ...
                    title: "Everybody club Иркутск",
                    dateFrom: "Ноябрь, 2021",
                    dateTo: "Сентябрь, 2022",
                    direction: "Программист разработчик",
                    profile: "Несколько внутренних проектов компании",
                    list: ["Разработка веб-сервиса для внутренних нужд компании - сервис распределения персонала на заявки.",
                    "Разработка системы для создания и проведения викторин.",
                    "Создание интерактивных кнопок для мероприятий."],
                }
            ],
        },
        {
